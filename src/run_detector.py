...
# ==============================================================
#out_file_path = CURR_PATH + "test.mp4"
...
class DataLoader_usbcam(object):
    ...
    def __init__(self):
        ...
        #self.cam = cv2.VideoCapture('/home/shamim/laptop/Human-Pose-Estimation-and-Action-Recognition/src/s.avi') 
        #capture from webcam
    ...
    def set_video_writer(self):
        return cv2.VideoWriter('/home/shamim/laptop/Human-Pose-Estimation-and-Action-Recognition/src/output_1.avi',
    ...
    def load_next_image(self):
        ...
        cv2.VideoWriter(out_file_path,
                          cv2.VideoWriter_fourcc(*'mp4v'),
                          write_fps=15,
                          (round(self.cam.get(cv2.CAP_PROP_FRAME_WIDTH)), round(cap.get(self.cam.cv2.CAP_PROP_FRAME_HEIGHT))))
        """
...
if __name__ == "__main__":
    ...
    wri=images_loader.set_video_writer()
    # -- Classify action
    if DO_INFERENCE:
